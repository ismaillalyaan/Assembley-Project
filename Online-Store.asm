...
E_QUANTITY DB 10,13,'      <-Total For This Step ||| QUANTITY: $'
...
INDEC3 PROC                        ;INDEC3 IS FOR TAKING INPUT FOR MULTIPLY WITH THE GIVEN AMOUNT
    ...
    AND AX,00FH  ;ma                   ;CONVERT TO DIGIT
...
MUL_: 
    ...
    ADD S, AX       ; Add the current price to the total
    JMP OUTPUT
...
OUTPUT2: 
    ...
    XOR AX,AX                        ;CLEAR AX
    MOV AX, S                        ;LOAD TOTAL INTO AX
    CALL OUTDEC2                     ;DISPLAY TOTAL
